      ...
      <div className="glass rounded-2xl p-4">
        <div className="grid gap-2 md:grid-cols-5">
          ...
          <BizDropdown
            ...
            options={[
              { value: "", label: "内容目标（全部）" },
              ...CONTENT_GOALS.map((o) => ({ value: o, label: o })),
            ]}
          />
          <BizDropdown
            value={formatFilter}
            ...
            options={[
              { value: "", label: "内容格式（全部）" },
              ...CONTENT_FORMATS.map((f) => ({ value: f, label: f })),
            ]}
          />
          <BizDropdown
            value={labelFilter}
              ...
              <tr key={t.id} className="border-t border-[hsl(var(--border)/0.35)] align-top">
                  ...
                  <details>
                    ...
                    <div className="mt-2 space-y-2">
                      ...
                      {isTextOnlyContentFormat(t.contentFormat) ? (
                        <div className="text-xs text-[hsl(var(--muted))]">口播/纯文预览</div>
                      ) : null}
                    </div>
                  </details>
                </td>
                <td className="px-3 py-3">
                  ...
                  {t.benchmarkUserLink?.trim() ? (
                    <div className="mt-1">
                      <div className="text-[10px] text-[hsl(var(--muted))]">用户对标</div>
                      <a
                        href={t.benchmarkUserLink}
                        target="_blank"
                        rel="noreferrer"
                        className="break-all text-xs text-[hsl(var(--accent))]"
                      >
                        {clipText(t.benchmarkUserLink, 36)}
                      </a>
                    </div>
                  ) : null}
                  {t.benchmarkUserImage?.trim() ? (
                    <div className="mt-1">
                      ...
                      <img
                        ...
                        alt="用户对标截图"
                        className="max-h-20 max-w-[100px] rounded border border-[hsl(var(--border)/0.45)] object-contain"
                      />
                    </div>
                  ) : null}
                </td>
