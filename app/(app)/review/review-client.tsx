                ...
                <td className="px-3 py-3">
                  {isHumanLabeled(t) ? (
                    ...
                    <div className="flex gap-1">
                      <button type="button" onClick={() => void patchTask(t.id, { action: "label", qualityLabel: "好" })} className="btn-secondary rounded-lg px-2 py-1 text-xs h-auto">好</button>
                      <button type="button" onClick={() => void patchTask(t.id, { action: "label", qualityLabel: "中" })} className="btn-secondary rounded-lg px-2 py-1 text-xs h-auto">中</button>
                      <button type="button" onClick={() => void patchTask(t.id, { action: "label", qualityLabel: "差" })} className="btn-secondary rounded-lg px-2 py-1 text-xs h-auto">差</button>
                    </div>
                  )}
                </td>
                <td className="px-3 py-3">
